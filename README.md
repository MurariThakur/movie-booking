...
- **Secure Payments**: Process payments safely with Stripe integration
...
- **Webhook Integration**: Automated booking confirmation after successful payment
- **Test Mode**: Safe testing environment with test cards

### Test Payment Details
For testing purposes, you can use Stripe's test card numbers:
...
- `POST /api/payment/confirm` - Confirm payment and finalize booking
