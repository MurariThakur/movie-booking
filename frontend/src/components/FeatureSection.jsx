  ...
  return (
    <div className="px-6 md:px-16 lg:px-24 xl:px-44 overflow-hidden">
      ...
      <div className="flex justify-center mt-20">
        <button onClick={()=>{navigate('/movies'); scrollTo(0, 0)}} className="px-10 py-3 text-sm bg-primary hover:bg-primary-dull transition rounded-md font-medium cursor-pointer">Explore Movies</button>
      </div>
    </div>
  );
};
